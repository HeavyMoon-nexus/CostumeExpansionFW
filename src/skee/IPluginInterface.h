...
// skee64 / RaceMenu public modder API header.
// Source: RaceMenu (by expired6978) "ModderResource" — IPluginInterface.h, v0.4.20.
// Vendored unmodified for build-time integration with skee's IBodyMorphInterface.
// Credit: expired6978 / RaceMenu (https://www.nexusmods.com/skyrimspecialedition/mods/19080).
// Not authored by this project; redistributed as the documented public integration API.
